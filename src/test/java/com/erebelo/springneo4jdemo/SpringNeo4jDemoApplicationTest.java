...
class SpringNeo4jDemoApplicationTest {
    ...
    void mainRunSuccessfully() {
        try (MockedStatic<SpringApplication> mockedStatic = mockStatic(SpringApplication.class)) {
            ...
            SpringNeo4jDemoApplication.main(new String[]{});

            mockedStatic.verify(() -> SpringApplication.run(SpringNeo4jDemoApplication.class, new String[]{}));
        }
    }
}
